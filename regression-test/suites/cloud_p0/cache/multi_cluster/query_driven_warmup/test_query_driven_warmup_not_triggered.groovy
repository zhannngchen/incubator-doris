...
suite('test_query_driven_warmup_not_triggered', 'docker') {
    ...
    docker(options) {
        ...
        // write data, then compaction, which will not trigger to delay add rowset
        sql """use @${clusterName1}"""
        ...
        // show not trigger delay to add rowset
        sql """use @${clusterName2}"""
